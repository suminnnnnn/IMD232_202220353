class Pendulum {
  ...
  setChild(pendulum) {
    this.childPendulum = pendulum;
    pendulum.setParent(this);
  }

  setParent(pendulum) {
    this.parentPendulum = pendulum;
  }
  ...
  applyGravity(gravity) {
    ...
    if (this.childPendulum) {
      this.childPendulum.applyGravity(gravity);
    }
  }
  ...
  mouseMoved(mX, mY) {
    ...
    if (this.childPendulum) {
      this.childPendulum.mouseMoved(mX, mY);
    }
  }
  ...
  mousePressed(mX, mY) {
    ...
    if (this.childPendulum) {
      this.childPendulum.mousePressed(mX, mY);
    }
  }
  ...
  mouseDragged(mX, mY) {
    ...
    if (this.childPendulum) {
      this.childPendulum.mouseDragged(mX, mY);
    }
  }
  ...
  mouseReleased() {
    this.isDragging = false;
    if (this.childPendulum) {
      this.childPendulum.mouseReleased();
    }
  }
}
